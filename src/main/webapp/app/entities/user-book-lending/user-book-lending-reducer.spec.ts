...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-book-lending.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERBOOKLENDING_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERBOOKLENDING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERBOOKLENDING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERBOOKLENDING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERBOOKLENDING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERBOOKLENDING actions', async () => {
      const expectedActions = [
        {
