...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIBRARYUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_LIBRARYUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LIBRARYUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LIBRARYUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LIBRARYUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LIBRARYUSER actions', async () => {
      const expectedActions = [
        {
