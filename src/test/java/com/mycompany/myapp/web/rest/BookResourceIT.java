...
class BookResourceIT {
    ...
    private static final String DEFAULT_ISBN = "2kI1]IHsgyjs7";
    private static final String UPDATED_ISBN = "978o0zB9R|W4RRcX1";

    private static final String DEFAULT_TITLE = "AAAAAAAAAA";
    private static final String UPDATED_TITLE = "BBBBBBBBBB";

    private static final Integer DEFAULT_YEAR = 2022;
    private static final Integer UPDATED_YEAR = 2021;
    ...
    void partialUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.isbn(UPDATED_ISBN).year(UPDATED_YEAR).note(UPDATED_NOTE);
